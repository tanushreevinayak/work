	...
	<div class="mainframe">
		<br><br>
  		...
  		<s:if test="%{#msg=='success'}">
  			<h2 align="center">Semester Course Deleted Successfully.</h2>
  		</s:if>
  		<s:elseif test="%{#msg=='failure'}">
  			<h2 align="center"><label class="control-label">Semester Course Already Deleted. </label></h2>			
  		</s:elseif>
  		<s:else>
		...
		<form class="form-horizental" action="AdminDeleteSemester" method="post" enctype="multipart/form-data" >
					<br><br>
			...
			<div class="form-group">
			  ...
			  <div class="col-lg-6">
			  		<div class="form-group">
     					 ...
     					 <div class="col-lg-8">
     					 		<sx:autocompleter list="semesterList" name="semesterId" showDownArrow="false"></sx:autocompleter>
     					 </div>
     					<br><br>
   					 </div>
			  </div>
			...
			<div class="col-lg-1">
			  	<div class="form-group">
      				<div class="col-lg-10 col-lg-offset-2">
      					<input type="submit" value="Delete Semester" class="btn btn-primary" />
					</div>
			 	</div>
			</div>
			<br><br><br><br><br><br>
