...
<label for="coursesyllabus">Course_Syllabus : </label>
<input type="text" name="course_syllabus" id="course_syllabus" value="<s:property value="course_syllabus"/> "class="form-control" >
</div>
