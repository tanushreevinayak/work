...
public class AdminViewSemesterCourse extends ActionSupport implements SessionAware,ModelDriven<ViewSemesterCourseModel>
{
	...
	private List<String> CourseCreditsList=new ArrayList<String>();
	
	private AddSemesterDao  viewSemesterCourses=new AddSemesterDao ();
...
//		setCourseList(obj.getCoursename(),obj.getCourseid(),obj.getCoursecredit());

		 setCourseIdList(obj.getCourseid());
		 setCourseList(obj.getCoursename());		
		 setCourseCreditsList(obj.getCoursecredit());

//		 setCourseCreditsList(viewSemesterCourses.getSemesterCourses(obj));
//		 CourseList=viewSemesterCourses.getSemesterCourses(obj);
		 System.out.println("return ffffffffrrrrrrommmmm ddddddaaaoooo class");
		 System.out.println("action"+getCourseList());
		 System.out.println("action"+getCourseIdList());
//			System.out.println("action"+obj.getCoursename());
//			System.out.println("action"+obj.getCourseid());
//			System.out.println("action"+obj.getCoursecredit());
	...
	public List<String> getCourseCreditsList() {
		return CourseCreditsList;
	}

	public void setCourseCreditsList(List<String> courseCreditsList) {
		CourseCreditsList = courseCreditsList;
	}
